...
- [apps/desktop/src/main/product-state/migrations/index.ts:1-20](file://apps/desktop/src/main/product-state/migrations/index.ts#L1-L20)
...
- execution_events：追加只写事件表，包含 seq（自增主键）、task_id（外键）、type、payload、occurred_at；触发器禁止更新与删除。
