...
- 关键点
  ...
  - 交付物闸口（TASK-026）：E2E 注入的是**真判定器 + 真端口**（realVerificationPorts），所以 20 轮跑通同时证明闸口在真实证据下放行；每轮事件从六条变成八条，末尾两条是 TS 侧的 verification_started / verification_passed。
...
**图表来源**
- [apps/desktop/src/main/e2e/golden-path.test.ts:124-157](file://apps/desktop/src/main/e2e/golden-path.test.ts#L124-L157)
- [apps/desktop/src/main/e2e/golden-path.test.ts:213-308](file://apps/desktop/src/main/e2e/golden-path.test.ts#L213-L308)
- [tests/fixtures/scripts/golden-path.json:1-22](file://tests/fixtures/scripts/golden-path.json#L1-L22)

**章节来源**
- [apps/desktop/src/main/e2e/golden-path.test.ts:1-307](file://apps/desktop/src/main/e2e/golden-path.test.ts#L1-L307)
- [tests/fixtures/scripts/golden-path.json:1-22](file://tests/fixtures/scripts/golden-path.json#L1-L22)
