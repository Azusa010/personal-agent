...
- [services/agent-runtime/src/personal_agent/runtime.py:187-256](file://services/agent-runtime/src/personal_agent/runtime.py#L187-L256)
...
### Python 运行时调试配置
- 启动方式：主进程通过 child_process.spawn 启动运行时命令：开发布局是 .venv/Scripts/python.exe -m personal_agent，打包布局是随包冻结产物 personal_agent.exe（TASK-029）。
...
章节来源
- [apps/desktop/src/main/runtime/python-supervisor.ts:231-337](file://apps/desktop/src/main/runtime/python-supervisor.ts#L231-L337)
- [services/agent-runtime/src/personal_agent/runtime.py:69-106](file://services/agent-runtime/src/personal_agent/runtime.py#L69-L106)
- [services/agent-runtime/src/personal_agent/host_channel.py:45-85](file://services/agent-runtime/src/personal_agent/host_channel.py#L45-L85)
