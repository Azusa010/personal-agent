...
- [model_gateway.py:6-85](file://services/agent-runtime/src/personal_agent/model_gateway.py#L6-L85)
...
- 两个实现（TASK-027）：ScriptedModel（CI 默认，确定性剧本按序吐决策）与 LiveModel（真模型，OpenAI Responses API 适配器，模型名只从 OPENAI_MODEL 读）。engine 分不出差别。
- 记账是第二个端口：LiveModel 额外实现 UsageReporting（usage_snapshot()），engine 收尾时 isinstance 问一次，把用量落成一条 model_usage 事件（插在终态事件之前）。ScriptedModel 不实现该端口，确定性链路的事件流一条不多——Golden Path E2E 逐条钉着事件类型。
...
AgentEngine --> UsageReporting : "收尾结算用量"
...
- [engine.py:91-103](file://services/agent-runtime/src/personal_agent/engine.py#L91-L103)
...
- [model_gateway.py:88-99](file://services/agent-runtime/src/personal_agent/model_gateway.py#L88-L99)
...
图表来源
- [engine.py:216-242](file://services/agent-runtime/src/personal_agent/engine.py#L216-L242)
- [host_channel.py:45-85](file://services/agent-runtime/src/personal_agent/host_channel.py#L45-L85)
...
章节来源
- [summary.py:30-85](file://services/agent-runtime/src/personal_agent/summary.py#L30-L85)
- [engine.py:137-146](file://services/agent-runtime/src/personal_agent/engine.py#L137-L146)
...
- [engine.py:119-127](file://services/agent-runtime/src/personal_agent/engine.py#L119-L127)
...
- [runtime.py:49-62](file://services/agent-runtime/src/personal_agent/runtime.py#L49-L62)
- [runtime.py:208-235](file://services/agent-runtime/src/personal_agent/runtime.py#L208-L235)
- [model_gateway.py:80-85](file://services/agent-runtime/src/personal_agent/model_gateway.py#L80-L85)
- [scripted_model.py:18-57](file://services/agent-runtime/src/personal_agent/scripted_model.py#L18-L57)
- [test_scripted_model.py:43-119](file://services/agent-runtime/tests/test_scripted_model.py#L43-L119)