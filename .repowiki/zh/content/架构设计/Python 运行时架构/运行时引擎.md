...
- [model_gateway.py:1-100](file://services/agent-runtime/src/personal_agent/model_gateway.py#L1-L100)
...
- [planning.py:1-77](file://services/agent-runtime/src/personal_agent/planning.py#L1-L77)
...
- [runtime.py:69-106](file://services/agent-runtime/src/personal_agent/runtime.py#L69-L106)
...
- 参考路径：
  ...
  - 工厂装配位置：[runtime.py:208-235](file://services/agent-runtime/src/personal_agent/runtime.py#L208-L235)
...
- 步骤：
  ...
  - 更新测试用例，覆盖新路径与错误分支。
- 参考路径：
  - 方法路由：[runtime.py:69-93](file://services/agent-runtime/src/personal_agent/runtime.py#L69-L93)
  - 事件构造：[engine.py:196-202](file://services/agent-runtime/src/personal_agent/engine.py#L196-L202)
...
- [engine.py:159-165](file://services/agent-runtime/src/personal_agent/engine.py#L159-L165)
- [agent.ts:4-138](file://packages/protocol/schemas/agent.ts#L4-L138)
...
- 参考路径：
  - 运行时测试：[test_runtime.py:162-634](file://services/agent-runtime/tests/test_runtime.py#L162-L634)
  - 脚本模型测试：[test_scripted_model.py:43-203](file://services/agent-runtime/tests/test_scripted_model.py#L43-L203)

章节来源
- [test_runtime.py:180-658](file://services/agent-runtime/tests/test_runtime.py#L180-L658)
