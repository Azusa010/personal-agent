...
- [apps/desktop/src/main/permission/permission-broker.ts:131-256](file://apps/desktop/src/main/permission/permission-broker.ts#L131-L256)
...
- 任务编排
  - run-task 负责计划生成、持久化、调用 Python 运行、事件落库、状态更新
...
- [apps/desktop/src/main/index.ts:129-165](file://apps/desktop/src/main/index.ts#L129-L165)
...
### 任务编排与时间线
- run-task：
  - 参数校验 -> 调用 Python 生成计划 -> 建 Task/Plan（事务A）-> 调用 Python 运行 -> 写事件/更新状态（事务B）
...
- [apps/desktop/src/main/runtime/python-supervisor.ts:211-241](file://apps/desktop/src/main/runtime/python-supervisor.ts#L211-L241)
- [apps/desktop/src/main/tasks/run-task.ts:104-114](file://apps/desktop/src/main/tasks/run-task.ts#L104-L114)
- [apps/desktop/src/main/permission/permission-broker.ts:274-319](file://apps/desktop/src/main/permission/permission-broker.ts#L274-L319)
...
参考路径
- [apps/desktop/src/main/tasks/run-task.ts:136-143](file://apps/desktop/src/main/tasks/run-task.ts#L136-L143)
