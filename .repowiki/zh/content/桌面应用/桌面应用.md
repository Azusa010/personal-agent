...
- [apps/desktop/src/renderer/src/App.tsx:21-92](file://apps/desktop/src/renderer/src/App.tsx#L21-L92)
...
- [apps/desktop/src/renderer/src/App.tsx:1-277](file://apps/desktop/src/renderer/src/App.tsx#L1-L277)
...
- [apps/desktop/src/main/permission/permission-broker.ts:1-320](file://apps/desktop/src/main/permission/permission-broker.ts#L1-L320)
...
**章节来源**
- [apps/desktop/src/main/index.ts:87-279](file://apps/desktop/src/main/index.ts#L87-L279)
- [apps/desktop/src/preload/index.ts:8-46](file://apps/desktop/src/preload/index.ts#L8-L46)
- [apps/desktop/src/renderer/src/App.tsx:21-179](file://apps/desktop/src/renderer/src/App.tsx#L21-L179)
...
**图表来源**
- [apps/desktop/src/main/index.ts:87-124](file://apps/desktop/src/main/index.ts#L87-L124)
- [apps/desktop/src/main/index.ts:127-270](file://apps/desktop/src/main/index.ts#L127-L270)
- [apps/desktop/src/main/index.ts:272-300](file://apps/desktop/src/main/index.ts#L272-L300)

**章节来源**
- [apps/desktop/src/main/index.ts:87-300](file://apps/desktop/src/main/index.ts#L87-L300)
...
**图表来源**
- [apps/desktop/src/renderer/src/main.tsx:3-11](file://apps/desktop/src/renderer/src/main.tsx#L3-L11)
- [apps/desktop/src/renderer/src/App.tsx:21-277](file://apps/desktop/src/renderer/src/App.tsx#L21-L277)
...
- 生产环境：electron-vite build 编译产物，electron-builder 打包为各平台安装包。
- 别名与插件：@personal-agent/protocol 指向共享协议 schema；React 与 Tailwind 插件用于渲染构建。
- 平台差异：Windows 可执行名、NSIS 快捷方式；macOS 权限描述与签名配置；Linux 目标格式（AppImage/snap/deb）。

```mermaid
flowchart LR
Dev["npm run dev"] --> Build["electron-vite build"]
Build --> Pack["electron-builder --win/--mac/--linux"]
Pack --> Artifacts["生成安装包/可执行文件"]
```
...
- [apps/desktop/electron-builder.yml:15-41](file://apps/desktop/electron-builder.yml#L15-L41)
...
### 跨平台兼容性
- Linux：窗口图标仅在 Linux 下注入；打包目标包含 AppImage、snap、deb。
- macOS：应用激活时若无窗口则重建；权限描述用于相机/麦克风/文档/下载文件夹访问；支持代码签名与公证开关。
- Windows：可执行名与 NSIS 安装器配置；快捷方式创建策略。
- 运行时路径解析针对 Windows venv 路径，确保 Python 解释器正确定位。

**章节来源**
- [apps/desktop/src/main/index.ts:51-67](file://apps/desktop/src/main/index.ts#L51-L67)
- [apps/desktop/src/main/index.ts:274-300](file://apps/desktop/src/main/index.ts#L274-L300)
...
**章节来源**
- [apps/desktop/src/main/index.ts:101-124](file://apps/desktop/src/main/index.ts#L101-L124)
...
参考路径
- [apps/desktop/src/main/index.ts:51-85](file://apps/desktop/src/main/index.ts#L51-L85)
- [apps/desktop/src/main/index.ts:274-278](file://apps/desktop/src/main/index.ts#L274-L278)
...
参考路径
- [apps/desktop/src/main/index.ts:94-99](file://apps/desktop/src/main/index.ts#L94-L99)
