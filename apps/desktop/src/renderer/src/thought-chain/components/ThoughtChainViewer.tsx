...
export const ThoughtChainViewer: React.FC<ThoughtChainViewerProps> = ({
  ...
  return (
    <div className={`space-y-2 text-left ${className}`}>
      {/* 顶部元数据工具条 */}
      <div className="flex flex-wrap items-center justify-between gap-2 rounded-lg border border-border/60 bg-muted/30 px-3 py-1.5 text-xs text-muted-foreground">
        {/* 统计指标 */}
        <div className="flex items-center gap-2 font-mono text-[11px]">
          <span className="font-semibold text-foreground">轨迹共 {stats.totalSteps} 步</span>
